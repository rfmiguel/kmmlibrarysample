...
@class SharedLinks, SharedRocket, SharedRocketLaunch, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing, SharedKotlinx_serialization_coreUpdateMode, SharedKotlinEnum<E>;
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getLaunchesWithCompletionHandler:(void (^)(NSArray<SharedRocketLaunch *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getLaunches(completionHandler:)")));
@end;
